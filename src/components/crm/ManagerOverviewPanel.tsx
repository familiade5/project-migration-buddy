  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button
          variant="outline"
          className="gap-2 bg-gray-900 border-gray-700 text-gray-100 hover:bg-gray-800 hover:text-white"
        >
      ...
      <SheetContent
        side="right"
        className="w-full sm:max-w-2xl lg:max-w-4xl bg-gray-950 border-gray-800 text-gray-100 p-0"
      >
        <SheetHeader className="px-6 py-5 border-b border-gray-800 bg-gray-900/50">
          <div className="flex items-center justify-between">
            <SheetTitle className="text-gray-100 text-lg font-semibold flex items-center gap-3">
          ...
          <div className="grid grid-cols-4 gap-3 mt-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-3 border border-red-900/30">
              <div className="text-2xl font-bold text-red-400">{stats.criticalIncomplete}</div>
                      ...
                      <TableCell className="py-3">
                        <div className="flex flex-col gap-0.5">
                          <div className="flex items-center gap-2">
                            <span className="font-mono text-sm text-gray-200 bg-gray-800 px-2 py-0.5 rounded">
                              {property.code}
                            </span>
                      ...
                      <TableCell className="py-3">
                        <div className="flex flex-wrap gap-1">
                          {property.missingItems.slice(0, 2).map((item, idx) => (
                            <span
                              key={idx}
                              className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20"
                            >
