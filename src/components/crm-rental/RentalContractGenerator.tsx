...
interface RentalContractGeneratorProps {
  contract: RentalContract;
  isOpen: boolean;
  onClose: () => void;
}

export function RentalContractGenerator({ contract, isOpen, onClose }: RentalContractGeneratorProps) {
  ...
  const handleSendForSignature = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Os links de assinatura foram gerados com sucesso.',
      });
    } catch (error) {
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            {!contract.tenant?.email && (
              <p className="text-sm text-amber-600 mb-3">
                ⚠️ O locatário não possui e-mail cadastrado. Cadastre o e-mail para enviar para assinatura.
              </p>
            )}
