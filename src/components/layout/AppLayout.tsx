        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 py-2 border-b" style={{ borderColor: '#E5E7EB' }}>
            <Link
              ...
              onClick={() => setSidebarOpen(false)}
              className="flex items-center justify-center w-full px-4 py-1.5 rounded-xl border transition-all hover:opacity-90"
              style={{ backgroundColor: '#EBF2FC', borderColor: '#C3D9F0' }}
            >
              <img src={logoAM} alt="Apartamentos Manaus" className="h-14 w-auto object-contain" />
            </Link>
          </div>
