 ...
 * Story 1: Curiosidade — foto dramática + texto impactante
 * Story 2: Revelação   — fotos maiores (68%) + card azul no rodapé
 * Story 3: CTA         — contato honesto e direto
 */
...
/* ── Story 1: Curiosidade ─────────────────────────────────────────────────────*/
export const AFStory3_T3_Curiosity = ({
  data,
  photo,
}: {
  data: AFPropertyData;
...
/* ── Story 2: Revelação ───────────────────────────────────────────────────────*/
export const AFStory3_T3_Reveal = ({
  data,
  photos,
}: {
  data: AFPropertyData;
    ...
    <div style={{ position: 'absolute', inset: 0, zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '44px 28px 32px' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <p style={{ color: 'white', fontSize: 14, fontWeight: 700, margin: '0 0 1px' }}>{data.brokerName || 'Corretor de Imóveis'}</p>
          {data.creci && <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 10, margin: 0 }}>{data.creci}</p>}
        </div>

        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 10, textAlign: 'center', margin: 0, lineHeight: 1.6 }}>
          🌐 www.apartamentosfortaleza.com
        </p>
      </div>
