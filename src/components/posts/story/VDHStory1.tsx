    ...
    >
      ...
      >
        ...
        >
          ...
          {/* ── RODAPÉ ESTILO FEED: cinza + badge colorido ── */}
          <div style={{ display: 'flex', minHeight: '240px' }}>

            {/* Badge financiamento — mesma cor do feed */}
            <div
              style={{
                flexShrink: 0,
                minWidth: '220px',
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '20px 24px', gap: '6px' }}>
              ...
              <img
                src={logoBase64}
                alt="VDH"
                style={{ height: '52px', objectFit: 'contain', objectPosition: 'left', marginBottom: '8px' }}
              />
              ...
              {locationLine && (
                <p style={{ fontSize: '24px', color: 'rgba(255,255,255,0.65)', lineHeight: 1.3 }}>
                  {locationLine}
                </p>
              )}
              {acceptsFGTS && (
              ...
              {price && (
                <p style={{ fontSize: '36px', fontWeight: 900, color: GOLD_BRIGHT, marginTop: '4px', letterSpacing: '-0.01em' }}>
                  {price}
                </p>
              )}
