...
export const VDHCorretorInfoSlide = ({}: Props) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', top: 80, left: 0, right: 0, display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 32 }}>
        <img src={logoBase64} alt="VDH" style={{ height: 150, objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
        <div style={{ width: 1.5, height: 100, backgroundColor: 'rgba(201,168,76,0.6)' }} />
        <img src={caixaBase64} alt="CAIXA AQUI" style={{ height: 160, objectFit: 'contain' }} />
      </div>
