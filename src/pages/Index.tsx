...
const Index = () => {
  ...
  return (
    <AppLayout>
      <div className="max-w-full overflow-x-hidden p-4 sm:p-6 lg:h-[100dvh] lg:overflow-hidden lg:p-8">
        <div className="flex h-full flex-col">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 lg:min-h-0 lg:flex-1">
            ...
            <div className="space-y-4 min-w-0 lg:min-h-0 lg:flex lg:flex-col">
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden lg:flex-1">
                <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100" style={{ backgroundColor: '#EEF2FF' }}>
                  <div className="flex items-center justify-between gap-2">
                    <div>
